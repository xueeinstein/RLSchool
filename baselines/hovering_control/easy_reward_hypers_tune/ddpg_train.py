...
def main(args):
    ...
    hovering_control_reward_hypers = [args.hc_alpha, args.hc_beta,
                                      args.hc_gamma]
    env = make_env('Quadrotor',
                   task=args.task,
                   healthy_reward=args.hc_healthy_reward,
                   reward_func_hypers=hovering_control_reward_hypers)
