...
class QuadrotorSim(object):
    ...
    def get_state(self):
        ...
        return {
            ...
            'g_v_x': self.global_velocity[0],
            'g_v_y': self.global_velocity[1],
            'g_v_z': self.global_velocity[2],
            'b_v_x': body_velocity[0],
            'b_v_y': body_velocity[1],
            'b_v_z': body_velocity[2],
            'w_x': self.body_angular_velocity[0],
            'w_y': self.body_angular_velocity[1],
            'w_z': self.body_angular_velocity[2],
            'pitch': pitch,
            'roll': roll,
            'yaw': yaw,
            'power': self.power
    ...
    def define_velocity_control_task(self, dt, nt, seed):
        ...
        for _ in range(nt):
            ...
            velocity = list(self.global_velocity)
